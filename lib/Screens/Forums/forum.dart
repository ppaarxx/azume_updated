...
import 'package:Azume_app/Screens/Forums/forum_screen.dart';
import 'package:Azume_app/Screens/Forums/question.dart';
      ...
      body: new Column(
          children: <Widget>[
            ...
            Card(
              ...
              child: Padding(
                padding: const EdgeInsets.fromLTRB(50.0, 5.0, 50.0, 7.0),
                child: TextButton(
                  onPressed: () {},
...
class IconWithText extends StatelessWidget {
  ...
  const IconWithText({Key? key, this.iconData, this.text, this.iconColor})
      : super(key: key);
      ...
      child: new Row(
        children: <Widget>[
          ...
          new Padding(
            ...
            child: new Text(this.text.toString()),
          ),
        ],
      ),
    );
